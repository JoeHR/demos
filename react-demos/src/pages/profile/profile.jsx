/*
 * @Author: rh
 * @Date: 2020-08-18 11:39:22
 * @LastEditTime: 2020-08-19 20:59:56
 * @LastEditors: rh
 * @Description: 命名规范
 * @变量: - 小驼峰式命名法（前缀应当是名词）
    ...
    return (
      <div className='profile-container'>
        {/* <QueueAnim type='bottom'> */}
          <Header title='我的' goBack={this.goBack.bind(this)} key='s1'></Header>
          <section key='s2'>
            ...
            <section className='info-date' key='i1'>
              <ul className='clear'>
                <Link to='/balance' className='icon-data-link'>
            ...
            <section className='profile-list'>
              <QueueAnim deley='0.4'>
                <div onClick={this.handleClick.bind(this,'unfinished')} className='myorder' key='i2'>
                  <div className='icon-dingdam order-icon'></div>
